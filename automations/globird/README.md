...
What the warranty actually says (and doesn't): we audited the current [GoodWe Australia/NZ residential battery warranty document](https://www.goodwe.com.au/Ftp/EN/Downloads/ZUO/GW_BAT-5-8_Warranty-AU.pdf) (Rev 1.0, July 2025 - covers GW5.1-BAT-D and GW8.3-BAT-D in both G20 and G21 revisions; these are the Lynx D modules most ESA installs stack to make their usable capacity) and the commercial-ESA warranty document (Rev 1.2, October 2025, covers the GW125/261-ESA-LCN-G10 industrial cabinet). **Neither document specifies a recommended SOC operating range** - there is no "stay between 10% and 90%" rule. Earlier drafts of this guide stated one; we've corrected that. What the residential warranty does specify:
...
- **Capacity expansion is warranty-supported, with no production-date matching requirement** ("Support capacity expansion, unlimited production time"). If you're eyeing a row of the sizing table below and wondering whether you can start smaller and add modules later - the warranty explicitly allows it, with the throughput tally accumulated on actual capacity. The one procedural ask: run a full charge/discharge cycle with the inverter after expanding, to recalibrate.
...
- Housekeeping fine print worth knowing: faults must be reported within two weeks of appearing and claimed within a month, and batteries must be installed within 6 months of production (with storage-condition rules if not).

The newer 6.0/9.0kWh modules from the June 2026 datasheets are **not** listed in that warranty document, and as of August 2026 no separate AU warranty for them has appeared on GoodWe's download centre - so if you're quoted those modules, ask the installer for their warranty terms in writing before applying any of the throughput math below.

The inverter side, for completeness: every current ESA model - single- and three-phase, hybrid and AC-coupled (EHA/ETA/BHA/BTA-G20) - carries a **10-year inverter warranty** per the [AU/NZ inverter system warranty](https://www.goodwe.com.au/Ftp/EN/Downloads/ZUO/GW_ESA-5-30kW_Warranty-AU-C.pdf) (Rev 5.8, December 2025). The discontinued ESA 5048 sits on the older 5-year tier, if you're buying second-hand.
