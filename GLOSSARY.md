...
| SolarGo | GoodWe's older consumer mobile app. Originally the primary end-user app and still the place where some low-level functions live (currently including the Modbus TCP toggle as far as we know). Increasingly being superseded by SEMS+ as GoodWe migrates features across. |
